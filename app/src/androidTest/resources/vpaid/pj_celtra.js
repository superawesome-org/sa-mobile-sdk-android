...
(function() {
    ...
    "ipCountryCode": "GB",
    "ipRegionCode": null,
    "ipPrincipalSubdivisionCode": "ENG",
    "ipCityGeonameId": "2655689",
    "ipCity": "Biggleswade",
    "ipPostalCode": "SG18",
    "ipLat": 52.085,
    "ipLng": -0.2683,
    "accountId": "097b4d42",
    "folderId": "043ddf25",
    "placementId": "c1301823",
    "supplierId": null,
    "sessionId": "s1700756671x6d58fbbbaabdbdx92729213",
    "purpose": "live",
    "secure": 1,
    "clientTimestamp": null,
    "clientTimeZoneOffsetInMinutes": null,
    "clientIp": "31.52.247.8",
    "gpsLat": null,
    "gpsLng": null,
    "language": "en",
    ...
    "googleMapsClientKey": "AIzaSyA9BXK60Qc7NkxIxywlwkdUxjlgDTV7JS8",
    "shouldShowMapsPrompt": false,
    "pageSkinsHost": null,
    "pageSkinsPath": null,
    "stickToPageHeader": null,
    "externalAdServer": "Custom",
    "externalCreativeId": null,
    "externalCreativeName": null,
    "externalPlacementId": null,
    "externalPlacementName": null,
    "externalSiteId": null,
    ...
    "campaignExplorer": null,
    "exportingFirstFrame": null,
    "exportingFrameRate": null,
    "exportingVideoAssetBlobHash": null,
    "country": "US",
    "productCategoryCode": null,
    "campaignName": "SuperAwesome 2021",
    "agencyId": null,
    "customPartnerAttributeBrandId": null,
    "suppressCloseButton": null,
    "featureFlags": {
        "defaultVideo": true,
        "perAccountRateLimiting": false,
        "iOS17InlineVideoFix": true,
        "noConfigSkinPositioning": false
    },
    "eventIndex": "0"
};
...
,['\\{celtraAccountId\\}', "097b4d42"]
,['\\{celtraAgencyId\\}', ""]
,['\\{celtraAndroidAdvIdTrackingLimitedBoolStr\\}', ""]
,['\\{celtraAndroidAdvIdTrackingLimited\\}', ""]
,['\\{celtraAndroidAdvId\\}', ""]
,['\\{celtraCampaignId:int\\}', "71163685"]
,['\\{celtraCampaignId\\}', "043ddf25"]
,['\\{celtraCampaignName\\}', "SuperAwesome%202021"]
,['\\{celtraCountryCode\\}', "US"]
,['\\{celtraCreativeId:int\\}', "69148624"]
,['\\{celtraCreativeId\\}', "041f1fd0"]
...
,['\\{celtraIosAdvId\\}', ""]
,['\\{celtraPlacementId:int\\}', "3241154595"]
,['\\{celtraPlacementId\\}', "c1301823"]
,['\\{celtraPlatformAdvIdTrackingLimited\\}', ""]
,['\\{celtraPlatformAdvId\\}', ""]
,['\\{celtraProductCategoryCode\\}', ""]
,['\\{celtraProto\\}', "https"]
,['\\{celtraRandom\\}', (Math.random()+'').slice(2)]
,['\\{celtraSessionId\\}', "s1700756671x6d58fbbbaabdbdx92729213"]
...
,['\\{celtraSupplierId\\}', ""]
    ...
    var payloadBase = "https://cache-ssl.celtra.com/api/creatives/041f1fd0/compiled/vpaid.js";
    var cacheParams = {"v": "30-a289ee2c04", "secure": 1, "cachedVariantChoices": "W10-", "isPurposePreview": 0, "eventMetadataExperiment": 'newMeta', "inmobi": typeof imraid !== 'undefined' && typeof _im_imai !== 'undefined' ? '1' : '0'};
...
var adLoadingEvent = {"name":"adLoading","sessionId":"s1700756671x6d58fbbbaabdbdx92729213"};
...
var payloadWin = null;
payload.src = "http://localhost:8080/pj_celtra_payload"; //payloadUrl;
...
! function(t) {
    function e() {
        Logger.initFromRuntimeParams(runtimeParams), this.trace("VPAIDAPI constructor"), this._eventHandler = extend({
            clearListeners: function(t) {
                var e = this._listeners;
                e && e[t] && (e[t] = [])
            }
        }, EventEmitter), this._proxyObject = null, this.adLinear = 1, this.adExpanded = 0, this.adSkippableState = 0, this.adCompanions = "", this.adIcons = 0, this.adWidth = 0, this.adHeight = 0, this.viewMode = "normal", this.adVolume = 1, Object.defineProperties(this, {
            adDuration: {
                get: function() {
                    return this.getAdDuration()
                }
            },
            adRemainingTime: {
                get: function() {
                    return this.getAdRemainingTime()
                }
            }
        }), this._startQueued = !1
    }
    var i = e.prototype;
    i.constructor = e, i.trace = function() {
        try {
            Logger("vpaid").log("CELTRA: " + JSON.stringify(arguments))
        } catch (t) {}
    }, i.setup = function(t) {
        Logger("vpaid").log("CELTRA: setup()"), this._proxyObject = t;
        var e, i = ["AdLoaded", "AdStarted", "AdStopped", "AdSkipped", "AdSkippableStateChange", "AdSizeChange", "AdLinearChange", "AdDurationChange", "AdExpandedChange", "AdRemainingTimeChange", "AdVolumeChange", "AdImpression", "AdVideoStart", "AdVideoFirstQuartile", "AdVideoMidpoint", "AdVideoThirdQuartile", "AdVideoComplete", "AdClickThru", "AdInteraction", "AdUserAcceptInvitation", "AdUserMinimize", "AdUserClose", "AdPaused", "AdPlaying", "AdLog", "AdError"];
        for (e in i) ! function(e) {
            this._proxyObject.on(e, function() {
                var t = {
                    eventName: e,
        ...
        this._startQueued && defer(function() {
            this._proxyObject.startAd()
        }.bind(this))
    }, i.handleEvent = function(t) {
        this.trace(t);
        var e = t.args || [];
        e.unshift(t.eventName), "AdVolumeChange" === t.eventName && this._handleAdVolumeChange(e[1]), this._eventHandler.emit.apply(this._eventHandler, e)
    }, i._handleAdVolumeChange = function(t) {
        this.adVolume = t, this.environmentVars.videoSlot.volume = t
    }, i.getAdIcons = function() {
        return !1
    }, i.getAdHeight = function() {
        return this.adHeight
    }, i.getAdWidth = function() {
        return this.adWidth
    }, i.getAdLinear = function() {
        return this.trace("getAdLinear()"), !0
    }, i.getAdRemainingTime = function() {
        return this.trace("getAdRemainingTime()"), this._proxyObject ? this._proxyObject.getAdRemainingTime() : -2
    }, i.getAdDuration = function() {
        return this.trace("getAdDuration()"), this._proxyObject ? this._proxyObject.getAdDuration() : -2
    }, i.setAdVolume = function(t) {
        this.trace("setAdVolume() value =", t), this.handleEvent({
            eventName: "AdVolumeChange",
            args: [t]
        })
    }, i.getAdVolume = function() {
        return this.trace("getAdVolume()"), this.adVolume
    }, i.handshakeVersion = function(t) {
        return this.trace("handshakeVersion()", t), "2.0"
    }, i.initAd = function(t, e, i, n, r, d) {
        this.trace("initAd()", t, e, i, n, r, d), this.environmentVars = d, this.adWidth = t, this.adHeight = e, this.viewMode = i, this.environmentVars.videoSlotCanAutoPlay && (void 0 !== (s = (a = this.environmentVars.videoSlot).play()) && s.then(function() {}).catch(function(t) {}), a.pause());
        var a, s = [].slice.apply(arguments);
        s.unshift(this), insertPayloadScript.apply(null, s), "1" === runtimeParams._fireAdLoadedOnInit && defer(function() {
            this.handleEvent({
                eventName: "AdLoaded",
                args: []
            })
        ...
        this.trace("startAd()"), this._proxyObject ? this._proxyObject.startAd() : this._startQueued = !0
    }, i.stopAd = function() {
        this.trace("stopAd()"), this._proxyObject.stopAd()
    }, i.skipAd = function() {
        this.trace("skipAd()"), this._proxyObject.skipAd()
    }, i.resizeAd = function(t, e, i) {
        this.trace("resizeAd()", t, e, i), this.adWidth = t, this.adHeight = e, this.viewMode = i, this._proxyObject.resizeAd(t, e, i)
    }, i.pauseAd = function() {
        this.trace("pauseAd()"), this._proxyObject.pauseAd()
    }, i.resumeAd = function() {
        this.trace("resumeAd()"), this._proxyObject.resumeAd()
    }, i.subscribe = function(t, e, i) {
        this._eventHandler.on(e, t.bind(i))
    }, i.unsubscribe = function(t) {
        this._eventHandler.clearListeners(t)
    }, i.handleError = function(t) {
        this.handleEvent({
            eventName: "AdError",
            args: [t]
        })
    }, i.getAdExpanded = function() {
        return 0
    }, i.getAdSkippableState = function() {
        return 0
    }, i.getAdCompanions = function() {
        return null
    }, i.expandAd = function() {
        return 0
    }, i.collapseAd = function() {
        return 0
