...
public class NewTestActivity extends AppCompatActivity {
    ...
    private SAManagedBannerAd banner = null;
    private SAManagedBannerAd mpu = null;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        banner = findViewById(R.id.managed_ad_banner);
        banner.setListener((SAInterface) (placementId, event) -> {

        });
        banner.load(58525);

        mpu = findViewById(R.id.managed_mpu);
        mpu.setListener((SAInterface) (placementId, event) -> {

        });
        mpu.load(58524);

        button = findViewById(R.id.managed_interstitial);
