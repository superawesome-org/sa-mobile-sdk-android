...
class SACustomWebView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : WebView(context, attrs, defStyleAttr) {
    interface Listener {
        fun webViewOnStart(view: SACustomWebView)
        fun webViewOnError()
        fun webViewOnClick(view: SACustomWebView, url: String)
    }
        ...
        webViewClient = object : WebViewClient() {
            ...
            override fun shouldOverrideUrlLoading(view: WebView?, url: String?): Boolean {
                if (finishedLoading) {
                    ...
                    listener?.webViewOnClick(view = this@SACustomWebView, url = fullUrl)
                    return true
                } else {
                    return false
                }
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                listener?.webViewOnStart(this@SACustomWebView)
            }
        }
    }
