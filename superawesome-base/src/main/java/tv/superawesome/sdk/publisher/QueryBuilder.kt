...
class QueryBuilder {
    ...
    /**
     * @param new a dictionary to be merged with an existing dictionary where only String or Int
    ...
    /**
     * @param new a dictionary to be merged with an existing JSONObject where only String or Int
     * values are supported.
