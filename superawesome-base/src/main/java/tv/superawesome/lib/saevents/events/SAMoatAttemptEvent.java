...
public class SAMoatAttemptEvent extends SAServerEvent {
    ...
    public SAMoatAttemptEvent(SAAd ad, ISASession session) {
        super(ad, session);
    }

    public SAMoatAttemptEvent(SAAd ad, ISASession session, Executor executor, int timeout, boolean isDebug) {
