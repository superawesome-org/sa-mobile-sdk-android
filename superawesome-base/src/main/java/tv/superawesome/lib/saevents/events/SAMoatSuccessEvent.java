...
public class SAMoatSuccessEvent extends SAServerEvent {
    ...
    public SAMoatSuccessEvent(SAAd ad, ISASession session) {
        super(ad, session);
    }

    public SAMoatSuccessEvent(SAAd ad, ISASession session, Executor executor, int timeout, boolean isDebug) {
