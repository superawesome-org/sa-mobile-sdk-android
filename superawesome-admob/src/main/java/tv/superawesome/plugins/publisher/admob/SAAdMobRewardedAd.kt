...
class SAAdMobRewardedAd(
    ...
    fun load() {
        ...
        if (mediationExtras != null) {
            ...
            Orientation.fromValue(mediationExtras.getInt(SAAdMobExtras.kKEY_ORIENTATION))?.let { SAVideoAd.setOrientation(it) }
            ...
            AdRequest.StartDelay.fromValue(mediationExtras.getInt(SAAdMobExtras.kKEY_PLAYBACK_MODE))?.let { SAVideoAd.setPlaybackMode(it) }
        }
